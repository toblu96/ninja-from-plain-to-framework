<template>
  ...
  <div v-if="$slidev.nav.currentPage !== 1">
    ...
    <footer
      class="absolute bottom-0 left-0 right-0 p-2 px-4 flex justify-between text-neutral-500"
    >
      <div><vscode-icons-file-type-ninja /></div>
      <div>From Plain to Framework</div>
